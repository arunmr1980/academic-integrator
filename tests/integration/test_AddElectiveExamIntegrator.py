...
class AddExamIntegratorTest(unittest.TestCase):
	...
	def get_current_lessonplans_from_json(self) :
		with open('tests/unit/fixtures/add-elective-exams-fixtures/current_lessonplans_list.json', 'r') as lessonplans_list:
			current_lessonplans = json.load(lessonplans_list)
		return current_lessonplans

	def get_current_teacher_calendars_list_json(self) :
		with open('tests/unit/fixtures/add-elective-exams-fixtures/current_teacher_calendars_list.json', 'r') as calendar_list:
	...
	def get_current_class_calendars_list_json(self) :
		with open('tests/unit/fixtures/add-elective-exams-fixtures/current_class_calendars_list.json', 'r') as calendar_list:
	...
	def get_expected_class_calendars_list(self) :
		...
		with open('tests/unit/fixtures/add-elective-exams-fixtures/expected_class_calendars_list.json', 'r') as calendar_list:
	...
	def get_expected_teacher_calendars_list(self) :
		...
		with open('tests/unit/fixtures/add-elective-exams-fixtures/expected_teacher_calendars_list.json', 'r') as calendar_list:
	...
	def get_expected_lessonplans_list(self) :
		...
		with open('tests/unit/fixtures/add-elective-exams-fixtures/expected_lessonplans_list.json', 'r') as lessonplan_list:
	...
	def get_exams_list_json(self) :
		with open('tests/unit/fixtures/add-elective-exams-fixtures/exams_list.json', 'r') as exam_list:
			exams_list = json.load(exam_list)
		return exams_list

	def get_class_info(self) :
		with open('tests/unit/fixtures/add-elective-exams-fixtures/class_info.json', 'r') as class_info_two:
