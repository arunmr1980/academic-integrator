...
class CalendarHolidayIntegratorTest(unittest.TestCase):
	...
	def test_lessonplan(self) :
		...
		updated_lessonplan_list = integrate_holiday_lessonplan(event_code,calendar_key,school_key)
		for updated_lessonplan in updated_lessonplan_list :
			self.check_lesson_plans(updated_lesson_plan,expected_lesson_plan_list)
