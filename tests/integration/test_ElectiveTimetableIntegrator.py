...
class TimetableIntegratorTest(unittest.TestCase):
	...
	def test_class_calendar(self) :
		...
		class_calender_list = calendar_service.get_all_calendars_by_key_and_type('test-class-key-1-elective-A','CLASS-DIV')
	...
	def test_teacher_calendar(self) :
		class_calendar_list = calendar_service.get_all_calendars_by_key_and_type('test-class-key-1-elective-A','CLASS-DIV')
		for class_calendar in class_calendar_list :	
			cal = calendar.Calendar(None)
			calendar_dict = cal.make_calendar_dict(class_calendar)	
			pp.pprint(calendar_dict)
		teacher_calendar_list = calendar_service.get_all_calendars_by_school_key_and_type('test-school-key-1-elective','EMPLOYEE')
	...
	def tearDownClass(self):
		...
		school_key = timetable.school_key
		academic_configuration = academic_service.get_academig(school_key,'2020-2021')
		classinfo = class_info_service.get_classinfo('test-class-key-1-elective')
		class_calender_list = calendar_service.get_all_calendars_by_key_and_type('test-class-key-1-elective--A','CLASS-DIV')
		...
		teacher_calender_list = calendar_service.get_all_calendars_by_school_key_and_type('test-school-key-1-elective','EMPLOYEE')
		for calendar in teacher_calender_list :
			calendar_service.delete_calendar(calendar.calendar_key)
			gclogger.info("--------------- Teacher calendar deleted " + calendar.calendar_key+" -----------------")

		school_calender_list = calendar_service.get_all_calendars_by_school_key_and_type('test-school-key-1-elective','SCHOOL')
	...
	def get_timetable_from_json(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/timetable.json', 'r') as calendar_list:
			timetable = json.load(calendar_list)
		return timetable

	def get_holiday_class_calendar_list_from_json(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/class_calendar_holiday_list.json', 'r') as calendar_list:
	...
	def get_holiday_school_calendar_list_from_json(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/school_calendar_holiday_list.json', 'r') as calendar_list:
	...
	def get_academic_config_from_json(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/academic_configuration.json', 'r') as academic_configure:
	...
	def get_expected_class_calendar_list(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/class_calendar_list.json', 'r') as calendar_list:
			class_calendar_dict_list = json.load(calendar_list)
		return class_calendar_dict_list

	def get_class_info_from_json(self) :
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/class_info.json', 'r') as calendar_list:
			timetable = json.load(calendar_list)
		return timetable
