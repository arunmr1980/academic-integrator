...
class ElectiveTimetableIntegratorTest(unittest.TestCase):
	...
	def get_time_table(self):
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/timetable.json', 'r') as timetable:
			timetable = json.load(timetable)
		return ttable.TimeTable(timetable)


	def get_academic_configuration(self):
		with open('tests/unit/fixtures/elective-timetable-calendar-fixtures/academic_configuration.json', 'r') as academic_configuration:
