...
class LessonplanIntegratorTest(unittest.TestCase):
	...
	def get_expected_lesson_plan_list(self) :
		...
		with open('tests/unit/fixtures/elective-calendar-to-lessonplan-fixtures/expected_lesson_plan_single_cal.json', 'r') as lesson_plan_list:
	...
	def get_current_lesson_plan_list(self) :
		...
		with open('tests/unit/fixtures/elective-calendar-to-lessonplan-fixtures/current_lesson_plan_single_session.json', 'r') as lesson_plan_list:
	...
	def get_current_class_calendar(self) :
	    with open('tests/unit/fixtures/elective-calendar-to-lessonplan-fixtures/current_class_calendar.json', 'r') as calendar_json:
